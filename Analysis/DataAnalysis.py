...
def get_dataset(directory):
    outfile = "/Users/brianmendoza/Desktop/Rosetta_analysisDNA.txt"
    f = open(outfile,'w')
    os.chdir(directory)
    mylabels = True
...
get_dataset("/Users/brianmendoza/Desktop/RosettaCRISPR/4UN3/Ensemble_1/OFF_TARGET/ON_001899/full_mut_pdbs/")
